...
export const db = getFirestore(); //db--> base de datos

export function guardarTarea(email,comentarioPublicar,fechaCreacion){
  addDoc( collection(db,"Publicaciones") , {email,comentarioPublicar,fechaCreacion} ); //tareas es la coleccion creada donde guardaras los documentos osea los datos
} //se hace la conexion directa con firebase/firestore
...
export function actualizarObtenerTarea(callback){
